...
function(_fbx_find_library _name _lib _suffix)
    find_library(${_name}
            ...
            PATH_SUFFIXES lib/${fbx_compiler}/ub/${_suffix} lib/vs2015/x64/${_suffix} lib/vs2013/x64/${_suffix} lib/vs2012/x64/${_suffix} lib/vs2010/x64/${_suffix} lib/vs2008/x64/${_suffix} lib/vs2005/x64/${_suffix}
            )
